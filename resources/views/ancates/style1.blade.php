...
<body>
    {{-- {{ dd($user) }} --}}
    <form action="{{ route('ancate.store') }}" method="post" class="rating">
        @csrf
        <input type="hidden" name="line_id" value="{{ $user->line_id }}">
        <div class="star-area">
            <div class="star-area-title">話やすさはいかがでしたか？</div>
        ...
        <div class="star-area">
            <div class="star-area-title">サービスの質はいかがでしたか？</div>
            <div class="star-block">
        ...
        <div class="star-area">
            <div class="star-area-title">スタッフの対応はいかがでしたか？</div>
            <div class="star-block">
        ...
        <div class="star-area">
            <div class="star-area-title">施設の清潔さはいかがでしたか？</div>
            <div class="star-block">
        ...
        <div class="star-area">
            <div class="star-area-title">総合的な満足度はいかがでしたか？</div>
            <div class="star-block">

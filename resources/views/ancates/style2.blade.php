...
<body>
    ...
    <form action="{{ route('ancate2.store') }}" method="post" class="rating">
        ...
        <div class="star-area">
            <div class="star-area-title">2回目サービスの質はいかがでしたか？</div>
            <div class="star-block">
        ...
        <div class="star-area">
            <div class="star-area-title">2回目スタッフの対応はいかがでしたか？</div>
            <div class="star-block">
        ...
        <div class="star-area">
            <div class="star-area-title">2回目施設の清潔さはいかがでしたか？</div>
            <div class="star-block">
        ...
        <div class="star-area">
            <div class="star-area-title">2回目総合的な満足度はいかがでしたか？</div>
            <div class="star-block">
